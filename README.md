...
* [Arrow functions](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Functions/Arrow_functions)
  should be used where an anonymous function is expected:

  > Explanation:
  > * `this` keyword in arrow function binds to the upper scope's `this`. It prevents usage invalid `this` or usage less
  >    efficient `Function.prototype.bind` function.
  > * The notation is shorter than function expression's.
...
* Parentheses around arrow function parameters should be used only when necessary:

  > Explanation: for more clean and readable code.
