...
====================
  ...
  - [Приведение типов](#15)
  - [Переносы строк](#16)
  - [Многострочные цепочки вызовов](#17)
...
##<a name="17"></a>Многострочные цепочки вызовов
Каждая строка из цепочки вызовов должна находиться на уровень глубже родительского объекта и начинаться с оператора доступа к свойствам ".".
